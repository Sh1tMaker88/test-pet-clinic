...
import static org.springframework.test.web.servlet.request.c.get;
...
class OwnerControllerTest {
    ...
    void setUp() {
        owners = new HashSet<>();
        owners.add(Owner.builder().id(1L).lastName("Rolo").build());
        owners.add(Owner.builder().id(2L).lastName("Hex").build());
